...
class TestSYNStreamFrame(SYNStreamFrameCommon):
    ...
    def test_can_build(self):
        expected = b'\x80\x03\x00\x01\x03\x00\x00\x20\x7f\xff\xff\xff\x7f\xff\xff\xff\x20\x00x\xbb\xe3\xc6\xa7\xc2\x02\xa6\x23\x46\x10\x06\x25\x6c\xc6\x24\x00\x00\x00\x00\xff\xff'
